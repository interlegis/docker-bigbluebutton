...
# RUN echo 'Acquire::http::Proxy "http://172.17.0.1:8080";'  > /etc/apt/apt.conf.d/01proxy
RUN apt-get update && apt-get install -y --no-install-recommends apt-utils && apt-get install -y wget
